...
$(document).ready(function() {
    ...
    $('#tb_contractSignAll').DataTable({
        ...
        "columnDefs": [
              ...
              "ajax": {
                       url: '/statistic/getContractSignAll',
                       dataSrc: ''
                   },
    ...
    $('#tb_contractRefundAll').DataTable({
		"lengthChange": true,//是否允许用户自定义显示数量
        "bPaginate": true, //翻页功能
        "bFilter": false, //列筛序功能
        "searching": true,//本地搜索
        ...
        "columnDefs": [
         ...
         "ajax": {
                    url: '/statistic/getContractRefundAll',
                    dataSrc: ''
                },
    ...
    $('#tb_oVConfirmAll').DataTable({
        ...
        "columnDefs": [
         ...
         "ajax": {
                    url: '/statistic/getContractProductiveConfirmAll',
                    dataSrc: ''
                },
    ...
    $('#tb_oVSelfEvaAll').DataTable({
        ...
        "columnDefs": [
         ...
         "ajax": {
                    url: '/statistic/getContractProductiveEvaluateAll',
                    dataSrc: ''
                },
